...
alembic_cfg.set_main_option("sqlalchemy.url", ngp_db_url)
# -----------------------------------------------------------
...
from ngp.core.services.db.models import ngp_models
target_metadata = ngp_models.Base.metadata
